    ...
    render() {
        return (
            <ListGroupItem className="mb-4 border-top-0 border-right-0 border-left-0 pt-0 pr-0 pl-0">
                <ListGroupItemHeading><Link to={'/histoires/' + this.props.histoire_progression.slug}>{this.props.histoire_progression.titreRoman}</Link></ListGroupItemHeading>
                <div className="list-group-item-text">
                    ...
                    <Link to={'/histoires/' + this.props.histoire_progression.slug}>Commencer à lire</Link>
                </div>
            </ListGroupItem>
        );
    }
